...
const About = () => {
          ...
          <>
                ...
                <section>
                  <div className="max-w-7xl mx-auto px-3">
                    ...
                    md:grid-cols-4 gap-6 py-8">
                      {[
                        { icon: FaUsers, number: "5000", label: "Active Members", fade: 'fade-up' },
                        { icon: FaTrophy, number: "150", label: "Tournaments", fade: 'fade-down' },
                        { icon: FaCalendarAlt, number: "12", label: "Years of Excellence", fade: 'fade-up' },
                        { icon: FaAward, number: "50", label: "Championship Titles", fade: 'fade-down' }
                      ].map((stat, index) => (
                        <div key={index} className="basic-card p-6 cursor-pointer
                        text-center border border-gray-700" data-aos={stat.fade}>
                          <stat.icon className="text-3xl 
                        icon-bg mx-auto mb-3" />
                          <div className="text-xl lg:text-3xl my-2 font-bold text-white">
                            <CountUpOnScroll base={0} target={stat.number} duration={2} />+
                          </div>
                ...
                <section className="py-8">
                  <div className="max-w-7xl px-3 mx-auto">
                    <div className="grid md:grid-cols-2 gap-8">
                      <div data-aos="flip-down" className="bg-[#3F3F3F] p-8 rounded-xl border-l-4 
                  border[#01f6ff]">
                      ...
                      <div data-aos="flip-up" className="bg-[#3F3F3F] p-8 rounded-xl border-l-4 
                  border-[#01f6ff]">
                        <div className="flex items-center mb-4">
            ...
            <section className="py-8">
              <div className="mx-auto max-w-7xl px-3">
                ...
                primary-text text-center mb-[30px]">Our Core Values</h3>
              ...
              <div className="max-w-7xl mx-auto px-3">
                <div variants={fadeIn} className="space-y-8">
                  <div className="text-center">
                    <h3 className="text-2xl font-bold primary-text">Premier Tournaments & Leagues</h3>
                    <p className="text-gray-400 mt-2">Professional tournaments that define sporting excellence</p>
                  </div>

                  <div className="space-y-8">
                    <div
                      className="bg-gradient-to-r from-[#4B4D4E] to-transparent p-8 rounded-2xl">
                      <div className="flex items-center mb-6">
                        <div>
                          <h4 className="text-2xl font-bold text-white flex items-center">
                            ...
                            Red Riders Indoor Premiere League (RRIPL)</h4>
                          <p className="text-white mt-3">India's Premier Indoor Cricket Championship</p>
                        </div>
                      </div>
                          ...
                          <div className="space-y-3 mb-6">
                            ...
                            <ul className="text-gray-300 space-y-2">
                              <li className="flex items-center cursor-pointer change-icon">
                                <span className="icon-bg"><FaCheckCircle className=" mr-2" /></span> Professional live scoring system</li>
                              <li className="flex items-center cursor-pointer change-icon">
                                <span className="icon-bg"><FaCheckCircle className=" mr-2" /></span> HD streaming and commentary</li>
                              <li className="flex items-center cursor-pointer change-icon">
                                <span className="icon-bg"><FaCheckCircle className=" mr-2" /></span> Cash prizes worth ₹5,00,000</li>
                              <li className="flex items-center cursor-pointer change-icon">
                                <span className="icon-bg"><FaCheckCircle className=" mr-2" /></span> Professional umpiring panel</li>
                            </ul>
                          </div>
                        </div>
                        ...
                        <div>
                          <div className="bg-[#4B4D4E] p-6 rounded-xl mb-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-center">
                              ...
                              <div>
                                <div className="text-2xl font-bold icon-bg hover:text-white"><CountUpOnScroll base={0} target={45} />+</div>
                                <div className="text-gray-400 text-sm">Matches</div>
                              </div>
                              <div>
                                <div className="text-2xl font-bold icon-bg hover:text-white"><CountUpOnScroll base={0} target={240} />+</div>
                                <div className="text-gray-400 text-sm">Players</div>
                              </div>
                              <div>
                                <div className="text-2xl font-bold icon-bg hover:text-white">₹<CountUpOnScroll base={0} target={5} />L</div>
                      ...
                      <div className="flex flex-wrap gap-3 mt-6">
                        {["10 Seasons Completed", "Live Streaming", "Professional Umpires", "Player Awards", "Sponsorship Partners", "Media Coverage"].map((tag, index) => (
                          <span key={index} className="icon-bg season-btn cursor-pointer px-4 py-2 rounded-full text-sm font-medium text-gray-900 flex items-center">
            ...
            <section className="py-8" >
              <div className="max-w-7xl mx-auto px-3">
                <div variants={fadeIn} className="space-y-8">
                  <div className="text-center">
                    <h3 className="text-2xl font-bold primary-text">Sports Disciplines</h3>
                  ...
                  <div className="grid grid-cols-2 xs:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                    {[
                      ...
                      <div data-aos={index % 2 === 0 ? 'fade-right' : 'fade-left'} key={index} className="background-gray p-4 rounded-xl text-center hover:transform hover:scale-110 transition-all duration-300 group">
      ...
      case "Red Riders Management":
        return (
          ...
          >
            ...
            <div variants={fadeIn} className="grid grid-cols-2 md:grid-cols-4 gap-6 py-8">
              {[
  ...
  return (
    ...
    >
      ...
      {/* Footer */}
      <footer className="py-12 px-4 sm:px-6 lg:px-8 mt-auto">
